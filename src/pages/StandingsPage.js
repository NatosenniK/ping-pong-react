...
function StandingsPage() {
  ...
  return (
    <div>
      <>
      <Helmet>
        <title>Standings - Ping Pong Tracker</title>
        <meta name="description" content="View the standings of everyone on Ping Ponng Tracker and how they rank with onea nother." />
      </Helmet>
      {/* Page Wrapper */}
      <div id="wrapper">
